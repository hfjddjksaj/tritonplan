...
export default function App() {
  ...
  const conflictCount =
    new Set(
      ctl.weeklyConflicts
        .map((c) => (c.aCourseId < c.bCourseId ? `${c.aCourseId}|${c.bCourseId}` : `${c.bCourseId}|${c.aCourseId}`))
        .concat(
          ctl.finalConflicts.map((c) =>
            c.aCourseId < c.bCourseId ? `${c.aCourseId}|${c.bCourseId}` : `${c.bCourseId}|${c.aCourseId}`,
          ),
        ),
    ).size;
      ...
      <div className="app__body">
        ...
        <main className="main">
          ...
          {tab === 'calendar' ? (
            ...
            <FinalsView finals={ctl.finals} conflicts={ctl.finalConflicts} />
          )}
        </main>
      </div>
